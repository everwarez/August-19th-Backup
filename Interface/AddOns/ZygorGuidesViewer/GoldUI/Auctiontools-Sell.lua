...
function Appraiser:UpdateSellPriceFields()
	...
	bid_price_gold =   tostring(selling_price_bid):sub(0, -5) or 0
	bid_price_silver = tostring(selling_price_bid):sub(-4, -3) or 0
	bid_price_copper = tostring(selling_price_bid):sub(-2, -1) or 0

	buy_price_gold =   tostring(selling_price_buy):sub(0, -5) or 0
	buy_price_silver = tostring(selling_price_buy):sub(-4, -3) or 0
	buy_price_copper = tostring(selling_price_buy):sub(-2, -1) or 0
